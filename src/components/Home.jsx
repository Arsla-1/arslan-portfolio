      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            ...
            with expertise in MERN stack and major CMS like Wordpress, Shopify
            and Webflow.
          </p>
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-white px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer justify-self-start"
            >
              Portfolio
